...
#ifndef GDK_COLLISIONS_IMPL_MESH_DATA_H
#define GDK_COLLISIONS_IMPL_MESH_DATA_H

#include <gdk/collisions/types.h>
#include <gdk/collisions/mesh_data.h>
...
namespace gdk::collisions {
    ...
    public:
        ...
        ///
        /// \exception exception if the index buffer is malformed.
        [[nodiscard]] static mesh_data_ptr_type make(std::vector<vector3_type> aVertices,
    ...
    private:
        impl_mesh_data(std::vector<vector3_type> aVertices, std::vector<std::uint32_t> aIndices,
