...
#ifndef GDK_IMPL_COLLISION_EVENT_TRACKER_H
#define GDK_IMPL_COLLISION_EVENT_TRACKER_H
...
namespace gdk {
    ...
    public:
        ...
        impl_collision_event_tracker(collision_observer_type aCollisionObserver,
        ...
        void record_collision(const impl_collider_ptr_type &aA, const impl_collider_ptr_type &aB,
            const collision_vector3_type &aNormal, const collision_vector3_type &aPoint,
            const collision_floating_point_type aPenetration);
    ...
    private:
        ...
        collision_observer_type m_CollisionObserver;
