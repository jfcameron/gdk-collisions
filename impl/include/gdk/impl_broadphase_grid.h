...
#ifndef GDK_IMPL_BROADPHASE_GRID_H
#define GDK_IMPL_BROADPHASE_GRID_H
...
namespace gdk {
    ...
    struct broadphase_cell_key final {
        ...
        bool operator!=(const broadphase_cell_key &aOther) const noexcept { return !(*this == aOther); }
    };
    ...
    public:
        ...
        void gather_neighbours(const impl_collider &aCollider, const collision_delta_time_type aDeltaTime,
    ...
    private:
        ...
        [[nodiscard]] cell_key cell_coord(const collision_vector3_type &aValue) const {
